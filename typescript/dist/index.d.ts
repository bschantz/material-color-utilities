 ...
 */
declare class ColorSpecDelegateImpl2021 implements ColorSpecDelegate {
    primaryPaletteKeyColor(): DynamicColor;
    secondaryPaletteKeyColor(): DynamicColor;
    tertiaryPaletteKeyColor(): DynamicColor;
    neutralPaletteKeyColor(): DynamicColor;
 ...
 */
declare class ColorSpecDelegateImpl2025 extends ColorSpecDelegateImpl2021 {
    surface(): DynamicColor;
    surfaceDim(): DynamicColor;
    surfaceBright(): DynamicColor;
    surfaceContainerLowest(): DynamicColor;
 ...
 */
declare class ColorSpecDelegateImpl2026 extends ColorSpecDelegateImpl2025 {
    surface(): DynamicColor;
    surfaceDim(): DynamicColor;
    surfaceBright(): DynamicColor;
    surfaceContainerLowest(): DynamicColor;
 ...
 */
type SpecVersion = '2021' | '2025' | '2026';
/**
...
declare const spec_2021: ColorSpecDelegateImpl2021;
declare const spec_2025: ColorSpecDelegateImpl2025;
declare const spec_2026: ColorSpecDelegateImpl2026;
/**
 * Returns the ColorSpecDelegate for the given spec version.
 */
declare function getSpec(specVersion: SpecVersion): ColorSpecDelegate;
 ...
 */
declare class SchemeCmf extends DynamicScheme {
    constructor(sourceColorHct: Hct, isDark: boolean, contrastLevel: number, specVersion?: SpecVersion, platform?: Platform);
    constructor(sourceColorHcts: Hct[], isDark: boolean, contrastLevel: number, specVersion?: SpecVersion, platform?: Platform);
}
...
export { Blend, Cam16, ColorSpecDelegateImpl2021, ColorSpecDelegateImpl2025, ColorSpecDelegateImpl2026, Contrast, ContrastCurve, CorePalette, CorePalettes, DislikeAnalyzer, DynamicColor, DynamicScheme, Hct, HctSolver, LabPointProvider, MaterialDynamicColors, QuantizerCelebi, QuantizerMap, QuantizerWsmeans, QuantizerWu, Scheme, SchemeAndroid, SchemeCmf, SchemeContent, SchemeExpressive, SchemeFidelity, SchemeFruitSalad, SchemeMonochrome, SchemeNeutral, SchemeRainbow, SchemeTonalSpot, SchemeVibrant, Score, TemperatureCache, TonalPalette, ToneDeltaPair, Variant, ViewingConditions, alphaFromArgb, applyTheme, argbFromHex, argbFromLab, argbFromLinrgb, argbFromLstar, argbFromRgb, argbFromXyz, blueFromArgb, clampDouble, clampInt, customColor, delinearized, differenceDegrees, extendSpecVersion, getSpec, greenFromArgb, hexFromArgb, isOpaque, labFromArgb, lerp, linearized, lstarFromArgb, lstarFromY, matrixMultiply, redFromArgb, rotationDirection, sanitizeDegreesDouble, sanitizeDegreesInt, signum, sourceColorFromImage, sourceColorFromImageBytes, spec_2021, spec_2025, spec_2026, themeFromImage, themeFromSourceColor, whitePointD65, xyzFromArgb, yFromLstar };
export type { ColorGroup, ColorSpecDelegate, CorePaletteColors, CustomColor, CustomColorGroup, DeltaConstraint, Platform, PointProvider, SpecVersion, Theme, TonePolarity };
