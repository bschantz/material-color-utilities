...
class DynamicColor {
    ...
    getHct(scheme) {
        ...
        const answer = getSpec$2(scheme.specVersion).getHct(scheme, this);
     ...
     */
    getTone(scheme) {
        return getSpec$2(scheme.specVersion).getTone(scheme, this);
    }
    /**
 ...
 */
function getSpec$2(specVersion) {
    return specVersion === '2021' ? spec2021$1 : spec2025$1;
}
...
class ColorSpecDelegateImpl2021 {
    ...
    primary() {
        return DynamicColor.fromPalette({
            ...
            toneDeltaPair: () => new ToneDeltaPair(this.primaryContainer(), this.primary(), 10, 'nearer', false),
        });
    }
    primaryDim() {
        return undefined;
    ...
    secondary() {
        return DynamicColor.fromPalette({
            ...
            background: (s) => this.highestSurface(s),
            contrastCurve: () => new ContrastCurve(3, 4.5, 7, 7),
            toneDeltaPair: () => new ToneDeltaPair(this.secondaryContainer(), this.secondary(), 10, 'nearer', false),
        });
    }
    secondaryDim() {
        return undefined;
    ...
    tertiary() {
        return DynamicColor.fromPalette({
            ...
            background: (s) => this.highestSurface(s),
            contrastCurve: () => new ContrastCurve(3, 4.5, 7, 7),
            toneDeltaPair: () => new ToneDeltaPair(this.tertiaryContainer(), this.tertiary(), 10, 'nearer', false),
        });
    }
    tertiaryDim() {
        return undefined;
    ...
    error() {
        return DynamicColor.fromPalette({
            ...
            background: (s) => this.highestSurface(s),
            contrastCurve: () => new ContrastCurve(3, 4.5, 7, 7),
            toneDeltaPair: () => new ToneDeltaPair(this.errorContainer(), this.error(), 10, 'nearer', false),
        });
    }
    errorDim() {
        return undefined;
    ...
    primaryFixed() {
        return DynamicColor.fromPalette({
            ...
            background: (s) => this.highestSurface(s),
            contrastCurve: () => new ContrastCurve(1, 1, 3, 4.5),
            toneDeltaPair: () => new ToneDeltaPair(this.primaryFixed(), this.primaryFixedDim(), 10, 'lighter', true),
        });
    }
    primaryFixedDim() {
        return DynamicColor.fromPalette({
    ...
    secondaryFixed() {
        return DynamicColor.fromPalette({
            ...
            background: (s) => this.highestSurface(s),
            contrastCurve: () => new ContrastCurve(1, 1, 3, 4.5),
            toneDeltaPair: () => new ToneDeltaPair(this.secondaryFixed(), this.secondaryFixedDim(), 10, 'lighter', true),
        });
    }
    secondaryFixedDim() {
        return DynamicColor.fromPalette({
    ...
    tertiaryFixed() {
        return DynamicColor.fromPalette({
            ...
            background: (s) => this.highestSurface(s),
            contrastCurve: () => new ContrastCurve(1, 1, 3, 4.5),
            toneDeltaPair: () => new ToneDeltaPair(this.tertiaryFixed(), this.tertiaryFixedDim(), 10, 'lighter', true),
        });
    }
    tertiaryFixedDim() {
        return DynamicColor.fromPalette({
 ...
 */
function tMaxC$1(palette, lowerBound = 0, upperBound = 100, chromaMultiplier = 1) {
    let answer = findBestToneForChroma$1(palette.hue, palette.chroma * chromaMultiplier, 100, true);
 ...
 * @param upperBound The upper bound of the tone.
 */
function tMinC$1(palette, lowerBound = 0, upperBound = 100) {
    let answer = findBestToneForChroma$1(palette.hue, palette.chroma, 0, false);
    return clampDouble(lowerBound, upperBound, answer);
}
/**
 ...
 * @param byDecreasingTone Whether to search for lower tones.
 */
function findBestToneForChroma$1(hue, chroma, tone, byDecreasingTone) {
    let answer = tone;
 ...
 */
function getCurve$1(defaultContrast) {
...
class ColorSpecDelegateImpl2025 extends ColorSpecDelegateImpl2021 {
        ...
        const color2025 = DynamicColor.fromPalette({
            ...
            tone: (s) => {
                if (s.variant === Variant.VIBRANT) {
                    return tMaxC$1(s.neutralPalette, 0, 100, 1.1);
                }
                else {
            ...
            contrastCurve: (s) => s.isDark && s.platform === 'phone' ? getCurve$1(11) : getCurve$1(9),
        });
    ...
    onSurfaceVariant() {
        const color2025 = DynamicColor.fromPalette({
            ...
            contrastCurve: (s) => s.platform === 'phone' ?
                (s.isDark ? getCurve$1(6) : getCurve$1(4.5)) :
                getCurve$1(7),
        });
    ...
    outline() {
        const color2025 = DynamicColor.fromPalette({
            ...
            background: (s) => s.platform === 'phone' ? this.highestSurface(s) :
                this.surfaceContainerHigh(),
            contrastCurve: (s) => s.platform === 'phone' ? getCurve$1(3) : getCurve$1(4.5),
        });
    ...
    outlineVariant() {
        const color2025 = DynamicColor.fromPalette({
            ...
            background: (s) => s.platform === 'phone' ? this.highestSurface(s) :
                this.surfaceContainerHigh(),
            contrastCurve: (s) => s.platform === 'phone' ? getCurve$1(1.5) : getCurve$1(3),
        });
    ...
    primary() {
        const color2025 = DynamicColor.fromPalette({
                ...
                if (s.variant === Variant.NEUTRAL) {
                    ...
                    if (s.platform === 'phone') {
                        if (s.isDark) {
                            ...
                            return tMaxC$1(s.primaryPalette);
                        }
                    }
                    else {
                        return tMaxC$1(s.primaryPalette, 0, 90);
                    }
                }
                else if (s.variant === Variant.EXPRESSIVE) {
                    if (s.platform === 'phone') {
                        return tMaxC$1(s.primaryPalette, 0, Hct.isYellow(s.primaryPalette.hue) ? 25 :
                    ...
                    if (s.platform === 'phone') {
                        return tMaxC$1(s.primaryPalette, 0, Hct.isCyan(s.primaryPalette.hue) ? 88 : 98);
                    }
                    else { // WATCH
                        return tMaxC$1(s.primaryPalette);
                    }
            ...
            background: (s) => s.platform === 'phone' ? this.highestSurface(s) :
                this.surfaceContainerHigh(),
            contrastCurve: (s) => s.platform === 'phone' ? getCurve$1(4.5) : getCurve$1(7),
    ...
    primaryDim() {
        return DynamicColor.fromPalette({
            ...
            contrastCurve: () => getCurve$1(4.5),
            toneDeltaPair: () => new ToneDeltaPair(this.primaryDim(), this.primary(), 5, 'darker', true, 'farther'),
        });
    }
    onPrimary() {
        const color2025 = DynamicColor.fromPalette({
            ...
            contrastCurve: (s) => s.platform === 'phone' ? getCurve$1(6) : getCurve$1(7),
        });
        ...
        const color2025 = DynamicColor.fromPalette({
            ...
            tone: (s) => {
                if (s.platform === 'watch') {
                    ...
                    return s.isDark ? tMinC$1(s.primaryPalette, 35, 93) :
                        tMaxC$1(s.primaryPalette, 0, 90);
                }
                else if (s.variant === Variant.EXPRESSIVE) {
                    return s.isDark ? tMaxC$1(s.primaryPalette, 30, 93) :
                        tMaxC$1(s.primaryPalette, 78, Hct.isCyan(s.primaryPalette.hue) ? 88 : 90);
                }
                else { // VIBRANT
                    return s.isDark ? tMinC$1(s.primaryPalette, 66, 93) :
                        tMaxC$1(s.primaryPalette, 66, Hct.isCyan(s.primaryPalette.hue) ? 88 : 93);
                }
            },
            isBackground: true,
    ...
    primaryFixedDim() {
        const color2025 = DynamicColor.fromPalette({
            ...
            isBackground: true,
            toneDeltaPair: () => new ToneDeltaPair(this.primaryFixedDim(), this.primaryFixed(), 5, 'darker', true, 'exact'),
        });
    ...
    inversePrimary() {
        const color2025 = DynamicColor.fromPalette({
            name: 'inverse_primary',
            palette: (s) => s.primaryPalette,
            tone: (s) => tMaxC$1(s.primaryPalette),
            background: () => this.inverseSurface(),
            contrastCurve: (s) => s.platform === 'phone' ? getCurve$1(6) : getCurve$1(7),
        });
            ...
            tone: (s) => {
                if (s.platform === 'watch') {
                    return s.variant === Variant.NEUTRAL ?
                        90 :
                        tMaxC$1(s.secondaryPalette, 0, 90);
                }
                else if (s.variant === Variant.NEUTRAL) {
                    return s.isDark ? tMinC$1(s.secondaryPalette, 0, 98) :
                        tMaxC$1(s.secondaryPalette);
                }
                else if (s.variant === Variant.VIBRANT) {
                    return tMaxC$1(s.secondaryPalette, 0, s.isDark ? 90 : 98);
                }
                else { // EXPRESSIVE and TONAL_SPOT
                    return s.isDark ? 80 : tMaxC$1(s.secondaryPalette);
                }
            },
            isBackground: true,
            background: (s) => s.platform === 'phone' ? this.highestSurface(s) :
        ...
        return DynamicColor.fromPalette({
            ...
            tone: (s) => {
                if (s.variant === Variant.NEUTRAL) {
                    ...
                    return tMaxC$1(s.secondaryPalette, 0, 90);
                }
            },
            isBackground: true,
            background: () => this.surfaceContainerHigh(),
            contrastCurve: () => getCurve$1(4.5),
            toneDeltaPair: () => new ToneDeltaPair(this.secondaryDim(), this.secondary(), 5, 'darker', true, 'farther'),
        });
    }
    onSecondary() {
        const color2025 = DynamicColor.fromPalette({
        ...
        const color2025 = DynamicColor.fromPalette({
            ...
            tone: (s) => {
                if (s.platform === 'watch') {
                    ...
                    return s.isDark ? tMinC$1(s.secondaryPalette, 30, 40) :
                        tMaxC$1(s.secondaryPalette, 84, 90);
                }
                else if (s.variant === Variant.EXPRESSIVE) {
                    return s.isDark ? 15 : tMaxC$1(s.secondaryPalette, 90, 95);
                }
                else {
    ...
    secondaryFixedDim() {
        const color2025 = DynamicColor.fromPalette({
            ...
            isBackground: true,
            toneDeltaPair: () => new ToneDeltaPair(this.secondaryFixedDim(), this.secondaryFixed(), 5, 'darker', true, 'exact'),
        });
            ...
            tone: (s) => {
                if (s.platform === 'watch') {
                    return s.variant === Variant.TONAL_SPOT ?
                        tMaxC$1(s.tertiaryPalette, 0, 90) :
                        tMaxC$1(s.tertiaryPalette);
                }
                else if (s.variant === Variant.EXPRESSIVE || s.variant === Variant.VIBRANT) {
                    return tMaxC$1(s.tertiaryPalette, 0, Hct.isCyan(s.tertiaryPalette.hue) ? 88 : (s.isDark ? 98 : 100));
                }
                else { // NEUTRAL and TONAL_SPOT
                    return s.isDark ? tMaxC$1(s.tertiaryPalette, 0, 98) :
                        tMaxC$1(s.tertiaryPalette);
                }
            },
            isBackground: true,
        ...
        return DynamicColor.fromPalette({
            ...
            tone: (s) => {
                if (s.variant === Variant.TONAL_SPOT) {
                    return tMaxC$1(s.tertiaryPalette, 0, 90);
                }
                else {
                    return tMaxC$1(s.tertiaryPalette);
                }
            },
            isBackground: true,
            background: () => this.surfaceContainerHigh(),
            contrastCurve: () => getCurve$1(4.5),
            toneDeltaPair: () => new ToneDeltaPair(this.tertiaryDim(), this.tertiary(), 5, 'darker', true, 'farther'),
        });
    }
    onTertiary() {
        const color2025 = DynamicColor.fromPalette({
        ...
        const color2025 = DynamicColor.fromPalette({
            ...
            tone: (s) => {
                if (s.platform === 'watch') {
                    ...
                    if (s.variant === Variant.NEUTRAL) {
                        return s.isDark ? tMaxC$1(s.tertiaryPalette, 0, 93) :
                            tMaxC$1(s.tertiaryPalette, 0, 96);
                    }
                    else if (s.variant === Variant.TONAL_SPOT) {
                        return tMaxC$1(s.tertiaryPalette, 0, s.isDark ? 93 : 100);
                    }
                    else if (s.variant === Variant.EXPRESSIVE) {
                        return tMaxC$1(s.tertiaryPalette, 75, Hct.isCyan(s.tertiaryPalette.hue) ? 88 : (s.isDark ? 93 : 100));
                    }
                    else { // VIBRANT
                        return s.isDark ? tMaxC$1(s.tertiaryPalette, 0, 93) :
                            tMaxC$1(s.tertiaryPalette, 72, 100);
                    }
                }
            },
            isBackground: true,
    ...
    tertiaryFixedDim() {
        const color2025 = DynamicColor.fromPalette({
            ...
            isBackground: true,
            toneDeltaPair: () => new ToneDeltaPair(this.tertiaryFixedDim(), this.tertiaryFixed(), 5, 'darker', true, 'exact'),
        });
    ...
    error() {
        const color2025 = DynamicColor.fromPalette({
            ...
            tone: (s) => {
                if (s.platform === 'phone') {
                    return s.isDark ? tMinC$1(s.errorPalette, 0, 98) :
                        tMaxC$1(s.errorPalette);
                }
                else {
                    return tMinC$1(s.errorPalette);
                }
            },
            isBackground: true,
            background: (s) => s.platform === 'phone' ? this.highestSurface(s) :
    ...
    errorDim() {
        return DynamicColor.fromPalette({
            name: 'error_dim',
            palette: (s) => s.errorPalette,
            tone: (s) => tMinC$1(s.errorPalette),
            isBackground: true,
            background: () => this.surfaceContainerHigh(),
            contrastCurve: () => getCurve$1(4.5),
            toneDeltaPair: () => new ToneDeltaPair(this.errorDim(), this.error(), 5, 'darker', true, 'farther'),
        });
    }
    onError() {
        const color2025 = DynamicColor.fromPalette({
        ...
        const color2025 = DynamicColor.fromPalette({
            ...
            tone: (s) => {
                if (s.platform === 'watch') {
                    ...
                    return s.isDark ? tMinC$1(s.errorPalette, 30, 93) :
                        tMaxC$1(s.errorPalette, 0, 90);
                }
            },
            isBackground: true,
            background: (s) => s.platform === 'phone' ? this.highestSurface(s) : undefined,
 ...
 */
class ColorSpecDelegateImpl2026 extends ColorSpecDelegateImpl2025 {
    surface() {
    ...
    surfaceContainerHighest() {
        ...
        return extendSpecVersion(super.surfaceContainerHighest(), '2026', color2026);
    }
    onSurface() {
        const color2026 = DynamicColor.fromPalette({
            name: 'on_surface',
    ...
    primaryContainer() {
        const color2026 = DynamicColor.fromPalette({
            ...
            isBackground: true,
            background: (s) => this.highestSurface(s),
            toneDeltaPair: () => new ToneDeltaPair(this.primaryContainer(), this.primary(), 5, 'relative_lighter', true, 'farther'),
    ...
    secondaryContainer() {
        const color2026 = DynamicColor.fromPalette({
            ...
            isBackground: true,
            background: (s) => this.highestSurface(s),
            toneDeltaPair: () => new ToneDeltaPair(this.secondaryContainer(), this.secondary(), 5, 'relative_lighter', true, 'farther'),
            contrastCurve: (s) => s.contrastLevel > 0 ? getCurve(1.5) : undefined,
        });
    ...
    onSecondaryFixedVariant() {
        ...
        return extendSpecVersion(super.onSecondaryFixedVariant(), '2026', color2026);
    }
    tertiary() {
        const color2026 = DynamicColor.fromPalette({
            name: 'tertiary',
    ...
    tertiaryContainer() {
        const color2026 = DynamicColor.fromPalette({
            ...
            isBackground: true,
            background: (s) => this.highestSurface(s),
            toneDeltaPair: () => new ToneDeltaPair(this.tertiaryContainer(), this.tertiary(), 5, 'relative_lighter', true, 'farther'),
            contrastCurve: (s) => s.contrastLevel > 0 ? getCurve(1.5) : undefined,
        });
    ...
    errorContainer() {
        const color2026 = DynamicColor.fromPalette({
            ...
            isBackground: true,
            background: (s) => this.highestSurface(s),
            toneDeltaPair: () => new ToneDeltaPair(this.errorContainer(), this.error(), 5, 'relative_lighter', true, 'farther'),
            contrastCurve: (s) => s.contrastLevel > 0 ? getCurve(1.5) : undefined,
        });
 ...
 * limitations under the License.
 */
const spec_2021 = new ColorSpecDelegateImpl2021();
const spec_2025 = new ColorSpecDelegateImpl2025();
const spec_2026 = new ColorSpecDelegateImpl2026();
/**
...
class MaterialDynamicColors {
    ...
    static colorSpec = new ColorSpecDelegateImpl2026();
    highestSurface(s) {
 ...
 */
class DynamicScheme {
    static DEFAULT_SPEC_VERSION = '2021';
    static DEFAULT_PLATFORM = 'phone';
    /**
    ...
    constructor(args) {
        ...
        this.primaryPalette = args.primaryPalette ??
            getSpec(this.specVersion)
                .getPrimaryPalette(this.variant, this.sourceColorHct, this.isDark, this.platform, this.contrastLevel);
        this.secondaryPalette = args.secondaryPalette ??
            getSpec(this.specVersion)
                .getSecondaryPalette(this.variant, this.sourceColorHct, this.isDark, this.platform, this.contrastLevel);
        this.tertiaryPalette = args.tertiaryPalette ??
            getSpec(this.specVersion)
                .getTertiaryPalette(this.variant, this.sourceColorHct, this.isDark, this.platform, this.contrastLevel);
        this.neutralPalette = args.neutralPalette ??
            getSpec(this.specVersion)
                .getNeutralPalette(this.variant, this.sourceColorHct, this.isDark, this.platform, this.contrastLevel);
        this.neutralVariantPalette = args.neutralVariantPalette ??
            getSpec(this.specVersion)
                .getNeutralVariantPalette(this.variant, this.sourceColorHct, this.isDark, this.platform, this.contrastLevel);
        this.errorPalette = args.errorPalette ??
            getSpec(this.specVersion)
                .getErrorPalette(this.variant, this.sourceColorHct, this.isDark, this.platform, this.contrastLevel) ??
...
class SchemeCmf extends DynamicScheme {
    constructor(sourceColorOrList, isDark, contrastLevel, specVersion = '2026', platform = DynamicScheme.DEFAULT_PLATFORM) {
        if (specVersion !== '2026') {
        ...
        const secondaryPalette = TonalPalette.fromHueAndChroma(sourceColorHct.hue, sourceColorHct.chroma * 0.5);
        const tertiaryPalette = sourceColorHct.toInt() === secondarySourceColorHct.toInt() ?
        ...
        const neutralPalette = TonalPalette.fromHueAndChroma(sourceColorHct.hue, sourceColorHct.chroma * 0.2);
        const neutralVariantPalette = TonalPalette.fromHueAndChroma(sourceColorHct.hue, sourceColorHct.chroma * 0.2);
        const errorPalette = TonalPalette.fromHueAndChroma(23.0, Math.max(sourceColorHct.chroma, 50.0));
        super({
...
class SchemeContent extends DynamicScheme {
    constructor(sourceColorOrList, isDark, contrastLevel, specVersion = DynamicScheme.DEFAULT_SPEC_VERSION, platform = DynamicScheme.DEFAULT_PLATFORM) {
        super({
